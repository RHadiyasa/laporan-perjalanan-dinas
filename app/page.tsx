...
export default function UploadPage() {
  ...
  // File state (File objects from dropzones)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Convert Files to temporary object URLs so the store holds string paths
    // (actual server paths will be set after /api/upload in Task 3)
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <input
                  ...
                  className={inputClass(
                    submitted && nomorSuratTugas.trim() === "",
                  )}
                />
              </Field>
              ...
              >
                <input
                  ...
                  className={inputClass(
                    submitted && tanggalSuratTugas.trim() === "",
                  )}
                />
              </Field>
  ...
  return (
    <section className="bg-white rounded-xl border border-slate-200 p-5 space-y-4 shadow-sm">
      <div className="flex items-center gap-2">
        ...
        {required && (
          <span className="text-xs rounded-full bg-red-50 text-red-500 px-2 py-0.5 font-medium">
            Wajib
          </span>
        )}
        {optional && (
          <span className="text-xs rounded-full bg-slate-100 text-slate-400 px-2 py-0.5 font-medium">
            Opsional
          </span>
        )}
      </div>
